    ...
    public BackStackState(FragmentManagerImpl fm, BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            while (op != null) {
                ...
                this.mOps[i] = op.cmd;
                i = i2 + 1;
                this.mOps[i2] = op.fragment.mIndex;
                i2 = i + 1;
                this.mOps[i] = op.enterAnim;
                i = i2 + 1;
                this.mOps[i2] = op.exitAnim;
                i2 = i + 1;
                this.mOps[i] = op.popEnterAnim;
                i = i2 + 1;
                this.mOps[i2] = op.popExitAnim;
                if (op.removed != null) {
                    ...
                    while (i3 < N) {
                        i2 = i + 1;
                        this.mOps[i] = ((Fragment) op.removed.get(i3)).mIndex;
                        i3++;
                        i = i2;
                    }
                    i2 = i;
