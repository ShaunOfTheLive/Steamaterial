...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pframe.setVisibility(AccessibilityNodeInfoCompat.ACTION_CLEAR_SELECTION);
    ...
    private void setListShown(boolean shown, boolean animate) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (shown) {
                ...
                this.mProgressContainer.setVisibility(AccessibilityNodeInfoCompat.ACTION_CLEAR_SELECTION);
            ...
            this.mListContainer.setVisibility(AccessibilityNodeInfoCompat.ACTION_CLEAR_SELECTION);
        }
    }
        ...
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(AccessibilityNodeInfoCompat.ACTION_CLEAR_SELECTION);
                }
